...
namespace BankAccounts
{
    class Test
    {
        static void Main()
        {
            ...
            {
                new Deposit(new Individual("Hristo Mutafchiev"), 500, 0.034),
                new Loan(new Company("Microsoft Corporation"), 700, 0.023),
                new Mortgage(new Individual("Stoyanka Mutafova"), 300, 0.45)
            };
